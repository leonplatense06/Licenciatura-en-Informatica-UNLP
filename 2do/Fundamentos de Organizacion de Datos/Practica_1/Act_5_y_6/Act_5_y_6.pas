...
begin
	...
	writeln('MENU:');
	writeln();
	write('1- Exportar de Archivo de Texto a Archivo Binario.', LineEnding, '2- Mostrar Celulares Con Stock Insuficiente.', LineEnding, '3- Buscar Celulares Por su Descripcion.', LineEnding, '4- Exportar a Archivo TXT.', LineEnding, '0- Salir.', LineEnding, 'Eleccion: ');
	readln(op);
end;
